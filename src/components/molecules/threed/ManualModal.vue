<template>
    <section>
        ...
        <input v-model="inputNumbers" type="text" placeholder="000,001,002..." class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" :class="{ 'border-danger': error }" />
        ...
        <div class="flex mt-3 gap-2">
            ...
            <button @click="generateManualDigit" class="w-1/2 bg-success text-white py-2 rounded-md" data-bs-dismiss="modal">{{ $t('confirm') }}</button>
        </div>
    </section>
</template>
