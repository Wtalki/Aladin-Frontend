    ...
    <section>
        ...
        <div v-else class="p-3 space-y-3 h-screen overflow-y-scroll !pb-20">
            ...
            <div v-for="(bet, index) in bets" :key="index"
                ...
                <div class="my-2">
                    <span class="text-gray-400">{{ $t('lottery_betting_time') }}:</span>
                    <span class="text-light bg-yellow-400 p-1 rounded-lg">
                ...
                <div class="my-2">
                    ...
                    <span class="text-gold font-semibold">{{ bet.total_betting_amount }}</span>
                </div>
                <div class="my-2">
