<template>
    <section class="mx-auto space-y-5 p-5 !pb-32 w-full">
        <!-- <WalletCard /> -->
        <div class=" p-5 rounded-md shadow-md flex justify-between items-center">
            <Button type="link" route="/deposit"
                class="flex flex-col items-center text-sm text-dark font-semibold cursor-pointer">
        ...
        <div
            class="p-4 bg-primary rounded-md font-semibold shadow-md text-white border border-3 flex flex-col space-y-3">
        ...
        <a href="https://youtube.com/shorts/cen5Z2YrPP4?si=tSaCTMgKLiFzB7gg" target="blank"
            class="p-2 bg-primary cursor-pointer rounded-md font-semibold shadow-md text-white border border-3 flex items-center space-x-3">
