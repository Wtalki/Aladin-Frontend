<template>
    <section class="space-y-5 p-5 appWidth mx-auto bg-secondary h-[150vh]">
        ...
        <ul class="font-semibold list-disc text-warning px-4">
        ...
        <form class="space-y-2" @submit="addBankAccount">
            ...
            <Button type="submit"
                class="py-3 w-full px-4 text-center rounded-lg leading-5 text-primary bg-warning border border-secondary">အတည်ပြုသည်</Button>
        </form>
    </section>
</template>
